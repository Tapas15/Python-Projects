...
if __name__ == '__main__':
    ...
    camera0 = 'speedcode.mp4'
    camera1 = 'speedcode.mp4'
    camera2 = 'speedcode.mp4'
    camera3 = 'speedcode.mp4'
    camera4 = 'speedcode.mp4'
    camera5 = 'speedcode.mp4'
    camera6 = 'speedcode.mp4'
    camera7 = 'speedcode.mp4'
    camera8 = 'speedcode.mp4'
    # Create camera widgets
